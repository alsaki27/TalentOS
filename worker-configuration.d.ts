/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareGeneratedEnv` (hash: 7deec89cd6824991a72a93c3286eea38)
// Runtime types generated with workerd@1.20260918.1 2025-06-20 nodejs_compat
interface __BaseEnv_CloudflareGeneratedEnv {
	...
	GMAIL_SHARED_EMAIL: string;
	RESUME_STORAGE_PROVIDER: string;
	USAJOBS_API_KEY: string;
	USAJOBS_USER_AGENT: string;
	MARKITDOWN_SERVICE_URL: string;
	ALLOW_GLOBAL_AI_FALLBACK: string;
	CANDIDATE_GMAIL_ENABLED: string;
	CANDIDATE_JOB_MATCHER_ENABLED: string;
	CRM_SERVICE: Fetcher /* skarion-crm-platform */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker-entry");
	}
	interface Env extends __BaseEnv_CloudflareGeneratedEnv {}
}
interface CloudflareGeneratedEnv extends __BaseEnv_CloudflareGeneratedEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STAFF_GOOGLE_AUTH_ENABLED" | "CANDIDATE_GOOGLE_AUTH_ENABLED" | "CANDIDATE_MFA_ENABLED" | "BASE_RESUME_KEYWORD_AGENT_ENABLED" | "CANDIDATE_JOB_MATCHER_MODE" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY" | "SUPABASE_ANON_KEY" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "MS_TENANT_ID" | "MS_CLIENT_ID" | "MS_CLIENT_SECRET" | "SHAREPOINT_SITE_ID" | "SHAREPOINT_DRIVE_FOLDER" | "DATABASE_URL" | "DB_PROVIDER" | "ADMIN_EMAIL" | "CLERK_SECRET_KEY" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "JWT_SECRET" | "CRON_SECRET" | "JOB_CEO_INGEST_SECRET" | "TALENTOS_BASE_URL" | "HF_TOKEN" | "CRAWLER_API_KEY" | "TALENT_OS_WEBHOOK_SECRET" | "AI_PROVIDER" | "GOOGLE_VERTEX_PROXY_SECRET" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY" | "ANTHROPIC_MODEL" | "NVIDIA_API_KEY" | "NVIDIA_MODEL" | "FALOOD_OPENAI_MODEL" | "AI_KEYS_ENCRYPTION_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_OAUTH_REDIRECT_URI" | "GMAIL_CLIENT_ID" | "GMAIL_CLIENT_SECRET" | "GMAIL_SHARED_EMAIL" | "RESUME_STORAGE_PROVIDER" | "USAJOBS_API_KEY" | "USAJOBS_USER_AGENT" | "MARKITDOWN_SERVICE_URL" | "ALLOW_GLOBAL_AI_FALLBACK" | "CANDIDATE_GMAIL_ENABLED" | "CANDIDATE_JOB_MATCHER_ENABLED">> {}
}
