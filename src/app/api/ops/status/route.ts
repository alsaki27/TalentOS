...
// GET -> admin-only system health snapshot: live db reachability + latency,
// row counts, and recent import run history/errors. Built directly out of this
// session's pain (an hour-long outage plus a wiped jobs table went
...
export async function GET() {
  ...
  const overrideCategories = new Set<string>();
