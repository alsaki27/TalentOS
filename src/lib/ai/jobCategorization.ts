...
// Removed getActiveCategories as we use freeform tags now
...
export async function categorizeOneJob(
  job: PendingJob
): Promise<{ ok: boolean; status: string; result?: AiCategorizationResult }> {
