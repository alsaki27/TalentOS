...
2026-06-19 - build, types, env vars, and auth were re-checked against the current repo state, not assumed from memory.
...
## Environment variables Ã¢â‚¬â€ full reference (frontend, `/`)
